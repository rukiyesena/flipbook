      ...
      "></div>             </div>
        <div class='content-article'>
          ...
          <div class='article-info'>
            ...
            <div class='ai-desc'>Walking among the nayture in the Rocky Mountain National Park, Colorado</div>
            <div class='ai-footer'>
...
.main-wrapper .scroll-content {
  ...
  top: 0;
  left: 0;
  width: 100%; /* Make sure it covers the entire width of the page */
  height: 100%; /* Make sure it covers the entire height of the page */
  overflow: auto;
}
