            ...
            <div style="margin: 15px;">
                ...
                <template slot-scope="{ data }">
                  <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="tr.stockEn" style="color: black; font-weight: bold;">
                      ...
                      <p style="font-weight: 400;">Br. Ağırlık: {{ isNaN(tr.stockAgirlik) ?
                        0 : Intl.NumberFormat().format(tr.stockAgirlik) }}</p>
                    </vs-td>
                    ...
                    <vs-td :data="data[indextr].stockPrice" style="color: black; font-weight: bold;">
                      ...
                      <vs-input style="font-size: inherit; color: black; font-weight: bold;  width: 75px;" size="small"
                        v-model="data[indextr].stockPrice" type="text" :name="'price_' + indextr"
                        @input="setCartItems(indextr, tr)" v-validate="'required'" />
                      <span class="text-danger text-sm" v-show="errors.has('price_' + indextr)">{{
                        errors.first('price_' + indextr)
                      }}</span>
                    </vs-td>
                    <vs-td :data="data[indextr].discountRateLine" style="color: black; font-weight: bold;">
                      <vs-input style="font-size: inherit; color: black; font-weight: bold;  width: 75px;" size="small"
                        v-model="data[indextr].discountRateLine" type="text" :name="'discount_' + indextr"
                        @input="setCartItems(indextr, tr)" v-validate="'required'" />
                      <span class="text-danger text-sm" v-show="errors.has('discount_' + indextr)">{{
                        errors.first('discount_' + indextr)
                      }}</span>
                    ...
                    <vs-td>
                      <div>
                        ...
                        <b-form-datepicker id="baslangic" v-model="data[indextr].termin" size="sm" placeholder="-"
                          @input="setCartItems(indextr, tr)" style=" width: 200px;" :date-format-options="{
                            year: 'numeric',
                            month: 'numeric',
                            day: 'numeric'
                          }" />
              ...
              <b-row style="margin-top: 15px;">
                <b-col cols="5">
                  <b-row>
                    ...
                    <b-col cols="7">
                      <vs-input size="small" v-model="gecerlilikSuresi" type="text" name="validFor"
                        v-validate="'required'" @input="setInputOffer" />
                  ...
                  <b-row>
                    <b-col cols="5" align-self="center">
                      <b-form-group :label="'* ' + $t('sevkTarihi') + ':'" label-for="h-first-name"
                        style="font-weight: bold;font-size: larger; " @input="setInputOffer">
                      </b-form-group>
                    </b-col>
                    <b-col cols="7">
                      <b-form-datepicker id="baslangic" v-model="sevkTarihi" size="sm" placeholder="-" name="sevkTarihi"
                        @input="setInputOffer" v-validate="'required'" style=" width: 200px;" :date-format-options="{
                          year: 'numeric',
                          month: 'numeric',
                          day: 'numeric'
                        }" />
                  ...
                  <b-row>
                    ...
                    <b-col cols="7">
                      <vs-input size="small" v-model="paymentType" type="text" name="paymentType" v-validate="'required'"
                        @input="setInputOffer" />
                ...
                <b-col>
                  <b-row>
                    <b-col cols="5" align-self="center">
                      <b-form-group :label="$t('pivotColumnGroupTotals') + $t('Weight') + ':'" label-for="h-first-name"
                        style="font-weight: bold;font-size: larger; ">
                      </b-form-group>
                    </b-col>
                    <b-col cols="7">
                      <vs-input size="small" v-model="ttweight" type="text" name="weight" v-validate="'required'"
                        @input="setInputOffer" />
                    </b-col>
                    <b-col>
                  ...
                  <b-row>
                    ...
                    <vs-textarea size="small" v-model="shipAddress" type="text" name="shipAddress"
                      v-validate="'required'" />
                ...
                <b-col cols="4">
                  <b-row align-h="end">
                    ...
                    <b-col cols="7">
                      <vs-input size="small" v-model="calculatedToplam" type="text" name="calculatedToplam"
                        v-validate="'required'" />
                  ...
                  <b-row align-h="end">
                    ...
                    <b-col cols="7">
                      <vs-input size="small" v-model="kdvUygulanmisGenelToplam" type="text"
                  ...
                  <b-row align-h="end">
                    ...
                    <b-col cols="7">
                      <vs-input size="small" v-model="totalDiscountRate" type="text" name="totalDiscountRate"
                        v-validate="'required'" />
                  ...
                  <b-row align-h="end">
                    ...
                    <b-col cols="7">
                      <vs-input size="small" v-model="totalGenelToplam" type="text" name="totalGenelToplam"
                        v-validate="'required'" />
              ...
              <div class="not-panel" style="margin-top: 15px">
                ...
                <div style="display: flex; align-items: center;">
                  <h6>Not4: </h6>
                  <vs-input type="text" class="styled-input" size="small" v-model="note1" @input="setInputOffer"
                    style="color: rgb(185, 0, 0); font-weight: bold; width: 650px;" />
                </div>

                <div style="display: flex; align-items: center;">
                  <h6>Not5: </h6>
                  <vs-input size="small" type="text" class="styled-input" v-model="note2" @input="setInputOffer"
...
export default {
  ...
  computed: {
    ...
    ttweight() {
      const tweight = this.cartItems.reduce((total, item) => total + parseFloat(isNaN(item.stockAgirlik) ? 0 : item.stockAgirlik), 0);
      return tweight;
    },
  ...
  mounted() {
    ...
    this.isDone = this.$route.params.onay
    ...
    if (this.isDone == "false") {
      ...
      this.sevkTarihi = this.offerItem.sevkTarihi;
      this.paymentType = this.offerItem.paymentType;
      ...
      this.note1 = this.offerItem.note1;
      this.note2 = this.offerItem.note2;
      this.description = "";
      this.taxOffice = this.offerItem.taxOffice;
      this.gecerlilikSuresi = this.offerItem.gecerlilikSuresi; // Default değeri burada 1 olarak ayarlanmıştır
      this.nakliye = this.offerItem.nakliye;
      this.odemeSekli = this.offerItem.odemeSekli;
